...
<div class="container">
    ...
    <form method="POST" action="{{URL::route('admin.product.store')}}" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input id="stock_number" name="stock_number" type="text" class="form-control" required value="{{ old('stock_number') }}">
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea id="description" name="description" type="text" class="form-control" required>{{ old('description') }}</textarea>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input id="price" name="price" type="number" step="0.01" class="form-control" required value="{{ old('price') }}">
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <div class="checkbox">
                        <label>
                            <input name="available" type="checkbox" value="1" {{old('available')? 'checked':''}}>Available
                        </label>
                    </div>
                </div>
            </div>
